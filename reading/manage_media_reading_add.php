...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                                ...
                                <div class="box-header with-border">
                                    <div class="row">
                                        <h4 class="box-title text-info col-md-10 text-left" style="margin: 0;"><i class="ti-arrow-left" style="cursor: pointer;" onclick="window.location.href='manage_media_reading'"></i>
                                            ...
                                            <b>ฟอร์มเพิ่มข้อมูลสื่อการอ่าน</b>
                                        </h4>
                                    </div>
                                </div>
                                <form class="form" id="form_media_reading_add" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="col-md-12 mb-2">
                                            <p>หากไม่ต้องการกรอกข้อมูลโปรดเว้นว่างไว้</h3>
                                        </div>
                                        ...
                                        <div class="row col-md-8 mt-2">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control height-input" name="media_name" id="media_name" autocomplete="off" placeholder="กรอกชื่อเรื่อง">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>ชื่อผู้แต่ง</label>
                                                    <input type="text" class="form-control height-input" name="author_name" id="author_name" autocomplete="off" placeholder="กรอกชื่อผู้แต่ง">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row col-md-8">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control height-input" name="link_e_book" id="link_e_book" autocomplete="off" placeholder="กรอกลิงค์ E-book">
                                                </div>
                                            </div>
                                            <?php if ($_SESSION['user_data']->role_id == 3) { ?>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control height-input" name="link_test" id="link_test" autocomplete="off" placeholder="กรอกลิงค์แบบทดสอบ">
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control height-input" name="link_know_test" id="link_know_test" autocomplete="off" placeholder="กรอกลิงค์แบบบันทึกหลังอ่าน">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row col-md-8 mt-2">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group pl-2">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="accept" style="font-weight: bold;"> ผู้ใช้งานยืนยันว่า สื่อที่นำเข้าในระบบเป็นสื่อที่สร้างขึ้นเองหรือได้รับอนุญาตอย่างถูกต้องตามกฎหมายจากเจ้าของลิขสิทธิ์ <br>ทางระบบขอสงวนสิทธิ์ไม่รับผิดชอบต่อความเสียหายหรือข้อพิพาทใดๆ ที่อาจเกิดขึ้นจากการนำเข้าสื่อที่ละเมิดลิขสิทธิ์ ผู้ใช้งานต้องรับผิดชอบต่อการกระทำดังกล่าวแต่เพียงผู้เดียว </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row btn-submit-class">
                                            <div class="col-md-12">
    ...
    <script>
        ...
        $('#form_media_reading_add').submit((e) => {
            e.preventDefault();
            ...
            const media_cover_file = document.getElementById('media_cover_file').files[0];
            ...
            //     return false;
            // }
            // if (typeof media_cover_file == 'undefined') {
            //     alert('โปรดแนบไฟล์หน้าปกสื่อ PDF')
            //     $('#media_cover_file').focus()
            //     return false;
            // }
            // if (typeof media_file == 'undefined') {
            //     alert('โปรดแนบไฟล์สื่อการอ่าน PDF')
            //     $('#media_file').focus()
            //     return false;
            // }
            <?php if ($_SESSION['user_data']->role_id == 3) { ?>
            ...
            if (media_cover_file) {
                formData.append('media_cover_file', media_cover_file);
            }

            formData.append('isChecked', isChecked);
            formData.append('insertMedia', true);
