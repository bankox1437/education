                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" class="form-control" id="event_id" name="event_id" value="">
                                                ...
                                                <div class="col-md-1">
                                                    <button type="submit" class="btn btn-rounded btn-primary btn-outline" style="margin-top: 23px;width: 100%;" onclick="saveEvent()">
                                    ...
                                    <div class="table-responsive">
                                        <table id="table" data-minimum-count-columns="2" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-side-pagination="server" data-url="controllers/setting_controller?getDataEventAm=true">
                                        </table>
                                    </div>
                                </div>
                            </div>
...
<script>
                ...
                [{
                    ...
                    },
                    {
                        ...
                        formatter: function(value) {
                            return `<img src="../manage_am/images/am_events/${value}" style="height: 50px;">`;
                        }
                    },
                    {
                        title: "จัดการ",
                        ...
                        formatter: function(value, row) {
                            return `<button class="btn btn-sm btn-warning" onclick="editEvent(${row.event_id})">แก้ไข</button>
                                    <button class="btn btn-sm btn-danger" onclick="deleteEvent(${row.event_id}, '${row.image}')">ลบ</button> `;
                        }
                    }
                ]
            ],
    ...
    function saveEvent() {
        ...
        formData.append("saveEventAm", true);
    ...
    function editEvent(event_id) {
        $.ajax({
            ...
            success: function(response) {
                ...
                // กรอกข้อมูลลงในฟอร์ม
                $('#event_id').val(data.event_id); // ต้องมี input hidden id="post_id"
    ...
    function deleteEvent(event_id, image_old) {
