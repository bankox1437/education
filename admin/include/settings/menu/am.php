...
$sql = "SELECT * FROM tb_menus WHERE type = 'am' ORDER BY order_number ASC";
$data_result = $DB->Query($sql, []);
$data_result = json_decode($data_result, true);
$menu_list = $data_result;

?>
<form class="form" id="setting_menu_am" enctype="multipart/form-data">
    <div class="row mt-3">
...
<script>
    $("#setting_menu_am").submit(function(e) {
        e.preventDefault();
