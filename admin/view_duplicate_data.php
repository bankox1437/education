                                ...
                                <div class="box-body no-padding">
                                    ...
                                    <div class="row align-items-center px-2">
                                        ...
                                        <div class="col-md-2 ml-auto mt-1" style="min-width: 200px;">
                                            <input type="text" class="form-control" id="searchInput" placeholder="ค้นหาด้วยชื่อ นศ." onkeyup="getDatauserByProDisSub()" />
                                        </div>
                                    </div>
                                    <table id="table" data-icons="icons" data-minimum-count-columns="2" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-side-pagination="server" data-url="controllers/user_controller?getDataUserDuplicate=true" data-response-handler="responseHandler">
                                    </table>
                                </div>
                                <!-- /.box-body -->
                            </div>
