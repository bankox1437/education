                        ...
                        <div class="col-12">
                            <div class="box">
                                <?php if ($_SESSION['user_data']->role_id != 4) { ?>
                                    <div class="box-header with-border ">
                                        <h6 class="box-title text-info" style="margin: 0;">
                                            ...
                                            <b>ผลประเมินคุณธรรมนักศึกษา</b>&nbsp;&nbsp;&nbsp;&nbsp;<span class="text-dark"></span>
                                        </h6>
                                    </div>
                                <?php } else { ?>
                                    <!-- <div class="box-header with-border ">
                                        <h6 class="box-title text-info" style="margin: 0;">
                                            <i class="ti-arrow-left" style="cursor: pointer;" onclick="window.location.href='../main_menu'"></i>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="ti-envelope mr-15"></i>
                                            <b>ผลประเมินคุณธรรมนักศึกษา</b>&nbsp;&nbsp;&nbsp;&nbsp;<span class="text-dark"></span>
                                        </h6>
                                    </div> -->
                                ...
                                <?php } else {
                                    ...
                                    $mode = "print";
                                    $_GET['estimate_id'] = $estimate_data->estimate_id;
                                ?>
                                    ...
                                    <div class="box-body no-padding">
                                        <div class="row m-2">
                                            <div class="col-md-12 d-flex justify-content-center">
                                                ...
                                                <h6 class="text-center mt-2"><?php echo $estimate_data->std_code . " - " . $estimate_data->std_name ?> ปีการศึกษา <?php echo $term_year ?></h6>
                                            </div>
                                        </div>
