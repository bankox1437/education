                            ...
                            <div class="box">
                                <div class="box-header with-border ">
                                    <h6 class="box-title text-info" style="margin: 0;">
                                        ...
                                        <b>ฟอร์มแก้ไขประเมินคุณธรรมนักศึกษา</b>&nbsp;&nbsp;&nbsp;&nbsp;<span class="text-dark"></span>
                                    </h6>
                                </div>
                                <!-- /.box-header -->
                                    ...
                                    <div class="row m-2">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="std_select" id="std_select" data-placeholder="เลือกนักศึกษา" style="width: 100%;" disabled>
                                                    <option><?php echo $estimate_data->std_code . " - " . $estimate_data->std_name ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" id="year" disabled>
                                                <?php foreach ($_SESSION['term_data'] as $value) { ?>
                                                    <?php $selected = ($value->term_id == $estimate_data->year) ? 'selected' : ''; ?>
                                                    <?php $current = ($value->term_id == $estimate_data->year) ? '' : ''; ?>
