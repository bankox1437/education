                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-3">
                                            <h4 class="ml-2 mt-1text-left mr-2" style="margin: 0;">
                                                ...
                                                <b>แบบติดตามหลังจบการศึกษา</b>
                                            </h4>
                                        </div>
                                        <?php include "../config/class_database.php";
                                        $DB = new Class_Database();
                                        $sql = "SELECT * FROM `stf_tb_after_gradiate`\n" .
                                            "WHERE\n" .
                                            "	std_id = :std_id";
                                        $data = $DB->Query($sql, ['std_id' => $_SESSION['user_data']->edu_type]);
                                        $aff_data = json_decode($data);
                                        if (count($aff_data) < 1) {
                                            echo '<a class="waves-effect waves-light btn btn-success btn-flat ml-2" href="form_after_gradiate_add"><i class="ti-plus"></i>&nbsp;แบบติดตามหลังจบการศึกษา</a>';
                                        }
                                        ?>
                                    </div>
                                </div>
