...
$arrSide = [
    "ร่วมกิจกรรมกับหมู่คณะด้วยความเป็นหนึ่งใจเดียวกัน",
    "เป็นผู้มีเหตุผล ยอมรับความคิดที่แตกต่างหลากหลาย",
    "มีภาวะความเป็นผู้นำและผู้ที่ดี",
    "ยอดรับในบทบาทหน้าที่ของตนเอง และของผู้อื่น ตลอดจนยอมรับการตัดสินของกลุ่ม"
];
