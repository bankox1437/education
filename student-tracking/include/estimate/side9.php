...
$arrSide = [
    "ปฏิบัติตนตามกฎระเบียบ ข้อบังคับและข้อตกลงของสถานศึกษาและสังคม",
    "เข้าร่วมกิจกรรมหรือปฏิบัติงานที่ได้รับมอบหมายและตรงต่อเวลา",
    "ปฏิบัติถูกต้องตามศีลธรรมที่ดีงาม",
    "เป็นผู้มีความรับผิดชอบต่อตนเอง ชุมชน สังคม"
];
