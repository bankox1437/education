...
$arrSide = [
    "แสดงท่าทางกริยาสุภาพ  อ่อนน้อมถ่อมตนต่อผู้อื่น  ด้วยความมั่นใจในตนเอง",
    "วาจาสุภาพ กล่าวคำขอบคุณหรือขอโทษได้อย่างเหมาะสมตามสถานการณ์",
    "สามารถคุมอารมณ์ที่ไม่พึงประสงค์ในสถานการณ์ต่าง ๆ ได้",
    "มีความสัมมาคารวะและวางตัวในสังคมได้เหมาะสมกับความเป็นไทย"
];
if ($mode == 'add') {
    $sum = 100;
    for ($i = 0; $i < count($arrSide); $i++) { ?>
        <tr class="side_<?php echo $side ?>">
            ...
            <td onclick="checkedbehavior(<?php echo $side ?>,<?php echo $side . ($i + 1) ?>,'<?php echo $side . '_' . ($i + 1) ?>_1')">
                <div class="form-group text-center">
                    <div class="c-inputs-stacked">
                        <input name="<?php echo $side . ($i + 1) ?>" type="radio" id="<?php echo $side . '_' . ($i + 1) ?>_1" class="with-gap radio-col-info input-vid" value="25" checked="true">
    ...
    for ($i = 0; $i < count($estimate_side); $i++) {
        ...
        <tr class="side_<?php echo $side ?>">
            ...
            <td onclick="checkedbehavior(<?php echo $side ?>,<?php echo $side . ($i + 1) ?>,'<?php echo $side . '_' . ($i + 1) ?>_1')">
                <div class="form-group text-center">
                    <div class="c-inputs-stacked">
                        <input name="<?php echo $side . ($i + 1) ?>" type="radio" id="<?php echo $side . '_' . ($i + 1) ?>_1" class="with-gap radio-col-info input-vid" value="25" <?php echo $estimate_side[$i]->checked == '25' ? 'checked' : '' ?>>
                        <label for="<?php echo $side . '_' . ($i + 1) ?>_1"></label>
                    </div>
                </div>
            </td>
