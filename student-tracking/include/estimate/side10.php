<tr>
    <td><b>10 จิตสำนึกความเป็นไทย รักชาติ ศาสน์ กษัตริย์และรักความเป็นไทย</b></td>
    <td>
...
$arrSide = [
    "มีจิตสำนัก ภูมิใจ รักในเกียรติภูมิความเป็นชาติ ศาสนา พระมหากษัตริย์ ชนชาติไทยและแผ่นดินไทย",
    "มีความรู้ ความเข้าใจเกี่ยวกับความเป็นมาของชาติและประวัติบุคคลสำคัญ"
];
    ...
    for ($i = 0; $i < count($arrSide); $i++) { ?>
        <tr class="side_<?php echo $side ?>">
            ...
            <td onclick="checkedbehavior(<?php echo $side ?>,<?php echo $side . ($i + 1) ?>,'<?php echo $side . '_' . ($i + 1) ?>_1')">
                <div class="form-group text-center">
                    <div class="c-inputs-stacked">
                        <input name="<?php echo $side . ($i + 1) ?>" type="radio" id="<?php echo $side . '_' . ($i + 1) ?>_1" class="with-gap radio-col-info input-vid" value="50" checked="true">
    ...
    for ($i = 0; $i < count($estimate_side); $i++) {
        ...
        <tr class="side_<?php echo $side ?>">
            ...
            <td onclick="checkedbehavior(<?php echo $side ?>,<?php echo $side . ($i + 1) ?>,'<?php echo $side . '_' . ($i + 1) ?>_1')">
                <div class="form-group text-center">
                    <div class="c-inputs-stacked">
                        <input name="<?php echo $side . ($i + 1) ?>" type="radio" id="<?php echo $side . '_' . ($i + 1) ?>_1" class="with-gap radio-col-info input-vid" value="50" <?php echo $estimate_side[$i]->checked == '50' ? 'checked' : '' ?>>
                        <label for="<?php echo $side . '_' . ($i + 1) ?>_1"></label>
                    </div>
                </div>
            </td>
