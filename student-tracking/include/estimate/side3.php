...
$arrSide = [
    "ดูแล/ช่วยเหลือ หรือให้การอุปการะเอาใจใส่บิดามารดา ผู้มีพระคุณ",
    "ตอบแทนบุญคุณอาสาช่วยเหลือ ครู อาจารย์ และสถานศึกษา",
    "มีส่วนร่วม  ช่วยเหลือและพัฒนาชุมชน สังคมหรือประเทศชาติ",
    "ปฏิบัติตนเป็นพลเมืองที่ดีของประเทศชาติ"
];
if ($mode == 'add') {
    $sum = 100;
