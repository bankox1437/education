...
<head>
    ...
    <title>แบบบันทึกการคัดกรองนักศึกษาเป็นรายบุคคล</title>
</head>
...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <div class="row align-items-center">
                                        <div class="col-md-4">
                                            <h4 class="box-title">แบบบันทึกคัดกรองนักศึกษารายบุคคล</h4>
                                        </div>
                                    </div>
                                    <div class="row mt-3 align-items-center">
                                        ...
                                        <?php if ($_SESSION['user_data']->role_id == 3) { ?>
                                            ...
                                            <a class="waves-effect waves-light btn btn-success btn-flat ml-2" href="form2_5_add"><i class="ti-plus"></i>&nbsp;บันทึกคัดกรองนักศึกษา</a>
                                        <?php } else { ?>
                                            <a class="waves-effect waves-light btn btn-success btn-flat ml-2" href="#" id="filter-data"><i class="ti-search"></i>&nbsp;ค้นหา</a>
    ...
    <!-- <script src="assets/js/view_js/form_2.5.js"></script> -->
    <script>
      ...
      <tr>
        ...
        : ""
          ...
          <td class="text-center">
              <a href="pdf/แบบบันทึกคัดกรองนักศึกษารายบุคคล?form_id=${element.screening_id}" target="_blank">
                  <button type="button" class="waves-effect waves-circle btn btn-circle btn-success mb-5"><i class="ti-printer"></i></button>
              </a>
          </td>
         ${role_id != 2 ? `
         <td class="text-center">
         <a href="form2_5_edit?screening_id=${element.screening_id}&std_name=${element.std_prename}${element.std_name}">
           <button type="button" class="waves-effect waves-circle btn btn-circle btn-warning mb-5"><i class="ti-pencil-alt"></i></button>
         </a>
       </td>
       <td class="text-center">
           <button type="button" class="waves-effect waves-circle btn btn-circle btn-danger mb-5" onclick="deleteDataForm(${element.screening_id})"><i class="ti-trash"></i></button>
       </td>` : ''}
      </tr>`;
            });
        }
        ...
        function deleteDataForm(id) {
            const confirmDelete = confirm("ต้องการลบข้อมูลนี้ หรือไม่?");
            if (confirmDelete) {
                $.ajax({
                    type: "POST",
                    url: "controllers/form_screening_controller",
                    data: {
                        delete_form_2_5: true,
                        id: id,
                    },
                    dataType: "json",
            ...
            if (pro_id == '0' && dis_id == '0' && sub_district_id == '0' && std_class == "0") {
                ...
                if (role_id == 1) {
                    obj = {
                        ...
                        getDataScreeningStdByWhere: true
                    }
                }
                ...
                if (role_id == 2) {
                    obj = {
                        ...
                        std_class: std_class,
                        sub_district_id: sub_district_id,
                        getDataScreeningStdByAmphur: true
                    }
                }
