...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>ประเภทนักศึกษา <b class="text-danger">*</b></label>
                                                    <select class="form-control" name="std_type" id="std_type">
                                                        <option value="0">เลือกประเภทนักศึกษา</option>
                                                        <option value="ปกติ">ปกติ</option>
                                                        <option value="เร่ร่อน">เร่ร่อน</option>
    ...
    <script type="text/javascript" src="js/view_js/form_1.1_add.js"></script>
</body>
