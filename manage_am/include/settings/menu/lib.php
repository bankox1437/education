...
$sql = "SELECT * FROM tb_menus WHERE type = 'lib' ORDER BY order_number ASC";
$data_result = $DB->Query($sql, []);
$data_result = json_decode($data_result, true);
$menu_list = $data_result;

?>
<form class="form" id="setting_menu_lib" enctype="multipart/form-data">
    <div class="row mt-3">
...
<script>
    $("#setting_menu_lib").submit(function(e) {
        e.preventDefault();
