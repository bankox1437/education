    ...
    <div class="container">
        <div class="quick-menu">
            ...
            <div class="menu">
                ...
                <a class="btn btn-warning d-flex align-items-center justify-content-center text-uppercase fw-bold text-center rounded-pill" onclick="setRadius(this, 'close-collapse-edu')" type="button" data-toggle="collapse" data-target="#collapsibleMenuEdu" aria-expanded="false" aria-controls="collapsibleMenuEdu">
                    <p class="m-0" style="font-weight: bold;">ข้อมูลสถานศึกษา <span class="close-collapse-edu"></span></p>
                </a>
                <!-- Collapsible Menu -->
                <div class="collapse" id="collapsibleMenuEdu">
                    <ul class="list-group">
                        <?php foreach ($links as $link) { ?>
                            <li class="list-group-item text-center" style="cursor: pointer;" onclick="location.href = '<?php echo $link['link'] ?>'">
                ...
                <!-- Button to toggle menu -->
                <a class="btn btn-warning d-flex align-items-center justify-content-center text-uppercase fw-bold text-center rounded-pill mt-2" onclick="setRadius(this, 'close-collapse')" type="button" data-toggle="collapse" data-target="#collapsibleMenu" aria-expanded="false" aria-controls="collapsibleMenu">
                    <p class="m-0" style="font-weight: bold;">ระบบสารสนเทศ <span class="close-collapse"></span></p>
                </a>
                <!-- Collapsible Menu -->
                <div class="collapse" id="collapsibleMenu">
                    <ul class="list-group">
                        <?php foreach ($links_menu as $link) { ?>
                            <li class="list-group-item text-center" style="cursor: pointer;" onclick="location.href = '<?php echo $link['link'] ?>'">
                                <a class="text-dark"><b><?php echo $link["title"] ?></b></a>
                            </li>
                        <?php } ?>
                ...
                <!-- Button to toggle menu -->
                <a class="btn btn-warning d-flex align-items-center justify-content-center text-uppercase fw-bold text-center rounded-pill mt-2" onclick="setRadius(this, 'close-collapse-chart')" type="button" data-toggle="collapse" data-target="#collapsibleMenuChart" aria-expanded="false" aria-controls="collapsibleMenuChart">
    ...
    <div id="sidebar" class="sidebar">
        <div class="quick-menu" style="padding: 0px;">
            ...
            <div class="menu" id="menu">
                <!-- Button to toggle menu -->
                <a class="btn btn-warning d-flex align-items-center justify-content-center text-uppercase fw-bold text-center rounded-pill" onclick="setRadius(this, 'close-collapse-edu')" type="button" data-toggle="collapse" data-target="#collapsibleMenuEdu" aria-expanded="false" aria-controls="collapsibleMenuEdu">
                    <p class="m-0" style="font-weight: bold;color: #ffffff;">ข้อมูลสถานศึกษา <span class="close-collapse-edu"></span></p>
                </a>
                <!-- Collapsible Menu -->
                <div class="collapse" id="collapsibleMenuEdu">
                    <ul class="list-group">
                ...
                <!-- Button to toggle menu -->
                <a class="btn btn-warning d-flex align-items-center justify-content-center text-uppercase fw-bold text-center rounded-pill mt-2" onclick="setRadius(this, 'close-collapse')" type="button" data-toggle="collapse" data-target="#collapsibleMenu" aria-expanded="false" aria-controls="collapsibleMenu">
                    <p class="m-0" style="font-weight: bold;color: #ffffff;">ระบบสารสนเทศ <span class="close-collapse"></span></p>
                </a>
                <!-- Collapsible Menu -->
                <div class="collapse" id="collapsibleMenu">
                    <ul class="list-group">
