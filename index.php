...
<body>
    ...
    <div class="row" style="margin-top: 30px;">
        ...
        <div class="col-md-4">
            <div class="menu-title-container">
                <a href="reading/manage_test_reading">
                    <h2 class="menu-title" style="cursor: pointer !important;"><?php echo $system_name3 ?> <i class="fa fa-hand-pointer-o"></i></h2>
                </a>
                <a href="visit-online/manage_share">
                    <h2 class="menu-title" style="cursor: pointer !important;"><?php echo $system_name4 ?> <i class="fa fa-hand-pointer-o"></i></h2>
                </a>
    ...
    <div class="row">
        <div class="col-md-12 mt-4" style="background-color: #ad7df7;border-radius: 20px;">
            ...
            <div class="row justify-content-center px-4 pb-4" style="overflow: hidden;gap: 10px;">
                <?php
