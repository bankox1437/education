...
<body class="hold-transition light-skin sidebar-mini theme-primary">
    ...
    <div class="wrapper">
        ...
        <?php //nclude 'include/sidebar.php'; 
        ?>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <?php if ($_SESSION['user_data']->role_id == 3) { ?>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>ช่องทางการสอน</label>
                                                        <input type="text" class="form-control height-input" name="channel" id="channel" autocomplete="off" placeholder="ระบุช่องทางการสอน">
                                                    </div>
                                                </div>
                                            </div>
                                        <?php } ?>
