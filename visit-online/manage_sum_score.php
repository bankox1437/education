...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                            ...
                            <div class="box">
                                <div class="box-body no-padding">
                                    <div class="row pl-2 mt-3 mb-3">
                                        <div class="col-md-12 row align-items-center">
                                            ...
                                            <h4 class="box-title" style="margin: 0;">
                                                ...
                                                ?>
                                                &nbsp; ข้อมูลคะแนนระหว่างเรียน
                                            </h4>
                                            <?php
                                            if ($_SESSION['user_data']->role_id == 3) { ?>
                                                <div class="col-md-2">
                                                    <a id="btn_add" class="waves-effect waves-light btn btn-success btn-flat ml-2 mt-1" href="manage_sum_score_add"><i class="ti-plus"></i>&nbsp;เพิ่มคะแนนรายวิชา</a>
                                                </div>
                                            <?php }
                                            ?>
                                            <div class="col-md-1">
                                    ...
                                    <table id="table" data-icons="icons" data-search="false" data-show-refresh="false" data-minimum-count-columns="2" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-side-pagination="server" \
                                        data-url="../view-grade/controllers/inter_study_controller?getSumScore=true<?php echo isset($_GET['std_class']) ? "&std_class=" . urlencode($_GET['std_class']) : '' ?><?php echo isset($_GET['user_id']) ? '&user_id=' . $_GET['user_id'] : '' ?>" data-locale="th-TH">
                                    </table>
                                </div>
                                <!-- /.box-body -->
                            </div>
    ...
    <script>
        ...
        function formatButtonEdit(data, row) {
            let html = `<a href="manage_sum_score_add?sub_id=${row.sub_id}&std_class=${row.std_class}">
