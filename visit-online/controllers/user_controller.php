...
if (isset($_POST['getDataUsers'])) {
    ...
    $response = ['status' => true, 'data' => $result, 'count' =>  $count];
...
if (isset($_POST['addAdmin'])) {
    ...
    if (!empty($resultInsert)) {
        ...
        if ($role_id == "custom") {
            $userModel->addRoleCustom($_POST['custom_role_name'], $resultInsert, $_POST['custom_role_id'], $_POST['sub_name'], $_POST['subdistrict_text']);
        }
    } else {
...
if (isset($_POST['edit_profile'])) {
    ...
    $surname = htmlentities($_POST['surname']);
    $password = htmlentities($_POST['password']);
    $channel = isset($_POST['channel']) ? htmlentities($_POST['channel']) : '';
