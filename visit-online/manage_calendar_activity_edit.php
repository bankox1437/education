...
<head>
    ...
    <title>นิเทศออนไลน์-แก้ไขข้อมูลปฎิทินกิจกรรม </title>
    <style>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="margin: 0;">
            <div class="container-full">
                ...
                $sql = "SELECT * FROM cl_calendar_activity WHERE act_id = :act_id";
                $data = $DB->Query($sql, ["act_id" => $_GET['act_id']]);
                            ...
                            <div class="box">
                                <div class="box-header with-border">
                                    <div class="row">
                                        <h4 class="box-title text-info col-md-10 text-left" style="margin: 0;"><i class="ti-arrow-left" style="cursor: pointer;" onclick="window.location.href='manage_calendar_activity'"></i>
                                            ...
                                            <b>ฟอร์มแก้ไขข้อมูลปฏิทินกิจกรรมสถานศึกษา</b>
                                        </h4>
                                    </div>
                                </div>
                                ...
                                <div class="form" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6    ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="act_id" id="act_id" value="<?php echo $data->act_id ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control height-input" name="activity_name" id="activity_name" autocomplete="off" placeholder="กรอกชื่อกิจกรรม" value="<?php echo $data->act_name ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>ผู้รับผิดชอบ <b class="text-danger">*</b></label>
                                                    <input type="text" class="form-control height-input" name="take_response" id="take_response" autocomplete="off" placeholder="กรอกผู้รับผิดชอบ" value="<?php echo $data->take_response ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        ...
                                                        <input type="hidden" class="custom-file-input" id="activity_file_old" name="activity_file_old" value="<?php echo $data->act_file_name ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" class="form-control height-input" rows="4" name="note" id="note" autocomplete="off" placeholder="กรอกหมายเหตุ"><?php echo $data->note ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="box-footer">
                                        <button type="button" class="btn btn-rounded btn-primary btn-outline"  id="form-edit-calendar-activity" >
    ...
    <script>
        $(document).ready(function() {
            flatpickr("#datetime", {
                ...
                defaultDate: new Date('<?php echo $data->date_time ?>'),
                time_24hr: true,
                locale: "th",
            });
        ...
        $('#form-edit-calendar-activity').click((e) => {
            e.preventDefault();
            const act_id = $('#act_id').val();
            const activity_file_old = $('#activity_file_old').val();
            ...
            formData.append('activity_file_old', activity_file_old);
            ...
            formData.append('editCalendarActivity', true);
