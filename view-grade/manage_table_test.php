...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                                ...
                                <div class="box-body no-padding">
                                    <div id="toolbar" class="row">
                                        <div class="col-12 row align-items-center">
                                            <h4 class="col-md-4">ข้อมูลตารางสอบ</h4>
                                            <div class="col-md-4">
                                            ...
                                            <?php if ($_SESSION['user_data']->role_id == 3) { ?>
                                                <a class="waves-effect waves-light btn btn-success btn-flat ml-2 mt-3" href="manage_table_test_add"><i class="ti-plus"></i>&nbsp;บันทึกตารางสอบ</a>
                                            <?php } ?>
                                        </div>
                                        <div class="col-12 row align-items-center">
                                            <?php
                                    ...
                                    <table id="table" data-icons="icons" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-minimum-count-columns="2" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-side-pagination="server" data-url="controllers/table_test_controller?getDataTableTest=true">
                                    </table>
                                </div>
                                <!-- /.box-body -->
                            </div>
    ...
    <script src="js/init-table/manage_table_test.js?v=<?php echo $version ?>"></script>

    <script>
        $(document).ready(async function() {
            initTable()
            $('.search input').attr('placeholder', 'ค้นหาด้วยชื่อ นศ.');
            // $('.search input').attr('placeholder', 'ค้นหาด้วยปีการศึกษา');
        ...
        function deleteTableTest(t_test_id, file_name) {
            const confirmDelete = confirm('ต้องการลบตารางสอบนี้หรือไม่?');
            if (confirmDelete) {
                $.ajax({
                    type: "POST",
