...
<head>
    ...
    <title>คะแนนคุณธรรม จริยธรรม</title>
    <style>
        #table td {
            padding: 10px;
        }
...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                                ...
                                <div class="box-body no-padding">
                                    <div id="toolbar" class="row align-items-center">
                                        <h4 class="ml-2 mt-1text-left mr-2" style="margin: 0;"><i class="ti-arrow-left" style="cursor: pointer;" onclick="window.location.href='index_student'"></i>
                                            &nbsp;&nbsp;<i class="fa fa-clipboard mr-15"></i>
                                            <b>ตารางคะแนนคุณธรรม จริยธรรม</b>
                                        </h4>
                                        <div>
                                    ...
                                    <table id="table" data-icons="icons" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-minimum-count-columns="2" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-side-pagination="server" data-url="controllers/moral_controller?stdGetDataMoral=true">
                                    </table>
                                </div>
                                <!-- /.box-body -->
                            </div>
    ...
    <script src="js/init-table/view_moral.js"></script>
