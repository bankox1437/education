...
function formatButtonEdit(data, row) {
  let html = `<a href="manage_kpc_add?edit=${row.kpc_id}">
...
function formatButtonDelete(data, row) {
  let html = `<button type="button" onclick="deleteKPC(${row.kpc_id})" class="waves-effect waves-circle btn btn-circle btn-danger mb-5 mt-1" style="width:30px;height:30px;"><i class="ti-trash" style="font-size:10px"></i></button>`;
  return html;
}
