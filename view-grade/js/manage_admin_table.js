...
function formatButtonLeaveDay(data, row) {
  let html = `<a onclick="gotoAddLeave(${row.id})">
                    <button type="button" class="waves-effect waves-circle btn btn-circle btn-info mb-5 mt-1" style="width:30px;height:30px;"><i class="ti-time" style="font-size:10px"></i></button>
                </a>`;
  return html;
}
    ...
    columns: [
      [
        ...
        },
        {
          ...
          align: "center",
          width: "120px",
          formatter: formatButtonLeaveDay,
          visible: role_id != 6 ? true : false
        },
        {
          field: "operate",
