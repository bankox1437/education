...
<head>
    ...
    <title>ฟอร์มจัดการรายชื่อนักศึกษาที่จบการศึกษา</title>
    <style>
        .table>thead>tr>th {
            padding: 0 5px;
        }
...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form id="form-add-std-test">
                                <div class="box">
                                    <div class="box-body">
                                        <h6 class="box-title text-info" style="margin: 0;"><i class="ti-arrow-left" style="cursor: pointer;" onclick="window.location.href='manage_std_finish'"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="ti-user mr-15"></i> <b>ฟอร์มจัดการรายชื่อนักศึกษาที่จบการศึกษา <?php echo $_GET['term'] ?></b></h6>
                                        <hr class="my-15">
                                        <div class="row">
                                            <div class="col-md-5">
    ...
    <script>
        ...
        $('#form-add-std-test').submit(async (e) => {
            ...
            $.ajax({
                type: "POST",
                url: "controllers/std_finish_controller",
                data: {
                    std_checked: std_obj,
                    insert_std_finish: true,
                ...
                success: async function(json) {
                    if (json.status) {
                        alert(json.msg);
                        window.location.href = 'manage_std_finish';
                    } else {
                        alert(json.msg);
                    }
                },
