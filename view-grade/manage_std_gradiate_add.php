...
<head>
    ...
    <title>ฟอร์มจัดการรายชื่อนักศึกษาที่คาดว่าจะจบ</title>
    <style>
        .table>thead>tr>th {
            padding: 0 5px;
        }
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form id="form-add-std-test">
                                <div class="box">
                                    <div class="box-body">
                                        <h6 class="box-title text-info" style="margin: 0;"><i class="ti-arrow-left" style="cursor: pointer;" onclick="window.location.href='manage_std_gradiate'"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="ti-user mr-15"></i> <b>ฟอร์มจัดการรายชื่อนักศึกษาที่คาดว่าจะจบ <?php echo $_GET['term']; ?></b></h6>
                                        <hr class="my-15">
                                        <div class="row">
                                            <div class="col-md-5">
    ...
    <script>
        ...
        function getDataStdToTable(std_class) {
            ...
            $.ajax({
                ...
                data: {
                    getDataStdToTableGradiate: true,
                    std_class: std_class,
                    term_id: term_id
                },
                dataType: "json",
        ...
        $('#form-add-std-test').submit(async (e) => {
            ...
            $.ajax({
                type: "POST",
                url: "controllers/std_gradiate_controller",
                data: {
                    std_checked: std_obj,
                    insert_std_gradiate: true,
                ...
                success: async function(json) {
                    if (json.status) {
                        alert(json.msg);
                        window.location.href = 'manage_std_gradiate';
                    } else {
                        alert(json.msg);
                    }
                },
