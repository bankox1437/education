...
<head>
    ...
    <title>จัดการคะแนนคุณธรรม จริยธรรม</title>
    <style>
        #table td {
            padding: 10px;
        }
...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                                ...
                                <div class="box-body no-padding">
                                    <div id="toolbar" class="row">
                                        <div class="col-12 row  align-items-center">
                                            <h4 class="col-md-4">ตารางคะแนนคุณธรรม จริยธรรม</h4>
                                            <div class="col-md-4">
                                            ...
                                            <?php if ($_SESSION['user_data']->role_id == 3) { ?>
                                                <a class="waves-effect waves-light btn btn-success btn-flat ml-2" href="manage_moral_add"><i class="ti-pencil-alt"></i>&nbsp;คะแนนคุณธรรม จริยธรรม</a>
                                            <?php } ?>
                                        </div>
                                        <div class="col-12 row align-items-center">
                                            <?php
                                    ...
                                    <table id="table" data-icons="icons" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-minimum-count-columns="2" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-side-pagination="server" data-url="controllers/moral_controller?getDataMoral=true">
                                    </table>
                                </div>
                                <!-- /.box-body -->
                            </div>
    ...
    <script src="js/init-table/manage_moral.js?v=<?php echo $version ?>"></script>
