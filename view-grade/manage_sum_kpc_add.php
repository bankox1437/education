        ...
        <div class="content-wrapper" style="<?php echo $_SESSION['user_data']->role_id == "show" ? '' : 'margin: 0;' ?>">
            <div class="container-full">
                ...
                if (isset($_GET['sub_id'])) {
                    $sqlSubject = "SELECT * FROM vg_sum_kpc WHERE sub_id = :sub_id AND user_create = :user_create AND std_class = :std_class";
                        ...
                        <div class="col-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h6 class="box-title text-info" style="margin: 0;"><i class="ti-arrow-left" style="cursor: pointer;" onclick="window.location.href='manage_sum_kpc'"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="ti-bar-chart-alt mr-15"></i> <b>ชั่วโมง กพช. ปีการศึกษา <?php echo  $term_name; ?></b>
                                    </h6>
                                </div>
                                <div class="box-body">
                                    <div class="row">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-bordered" style="font-size: 12px;">
                                                    <thead>
                                                        ...
                                                        $dataColumn = [];
                                                        if (isset($_GET['sub_id'])) {
                                                            $sqlColumn = "SELECT * FROM vg_sum_kpc_worksheet WHERE sub_id = :sub_id";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th colspan="<?php echo count($dataColumn) + 1; ?>" class="text-center" id="work_head" style="width: 500px;">ชื่อกิจกรรม</th>
                                                            <!-- <th rowspan="2" class="text-center vertical-header">คะแนนสอบปลายภาค</th> -->
                                                            <!-- <th rowspan="2" class="text-center vertical-header">รวมชั่วโมงทั้งสิ้น</th> -->
                                                        ...
                                                        <tr id="col_work">
                                                            ...
                                                            ?>
                                                            <th class="text-center vertical-header">รวมชั่วโมง กพช.</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="body-std">
                                                        <?php
                                                        if (count($std_data) > 0) {
                                                            ...
                                                            foreach ($std_data as $obj_std) {
                                                                $checkStd = [];
                                                                if (isset($_GET['sub_id'])) {
                                                                    $checStdSql = "SELECT * FROM vg_sum_kpc_worksheet vw
                                                                                    LEFT JOIN vg_sum_kpc_students vs on vw.work_id = vs.work_id 
                                                                ...
                                                                if (count($checkStd) > 0 || !isset($_GET['sub_id'])) {
                                                                    ...
                                                                    if (count($dataColumn) > 0) {
                                                                        ...
                                                                        $reason = "";
                                                                        foreach ($dataColumn as $key => $value) {
                                                                            $sqlStudentScore = "SELECT * FROM vg_sum_kpc_students WHERE work_id = :work_id AND std_id = :std_id";
                ...
                for (let i = 0; i < col_work.length; i++) {
                    ...
                    for (let j = 0; j < input_score.length; j++) {
                        ...
                        if (checkedStatus) {
                            ...
                            let final_score_val = 0; //$('#final_score_' + std_id).val();
                            let total_score_val = 0; //$('#total_score_' + std_id).val();
                            let level_val = 0; //$('#level_' + std_id).val();
