...
<head>
    ...
    <title>ตารางสอบ ( Exam Schedule )</title>
    <style>
        #table td {
            padding: 10px;
        }
...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="box">
                                ...
                                <table id="table" data-icons="icons" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-minimum-count-columns="2" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-side-pagination="server" data-url="controllers/table_test_controller?stdGetDataTableTest=true">
                                </table>
                            </div>
                            <!-- /.box-body -->
                        </div>
    ...
    <script src="js/init-table/view_table_test.js"></script>
