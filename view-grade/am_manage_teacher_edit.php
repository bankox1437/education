...
<head>
    ...
    <title>ฟอร์มแก้ไขผู้ใช้งาน</title>
    <style>
        /* .tooltip-custom {
            cursor: pointer;
        }
...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <h4 class="box-title text-info col-md-10 text-left" style="margin: 0;">
                                                <?php $pageBack = isset($_GET['url']) ? 'manage_role' : 'am_manage_teacher' ?>
                                                <i class="ti-arrow-left" style="cursor: pointer;" onclick="window.location.href = '<?php echo $pageBack ?>?pro=<?php echo $_GET['pro'] ?>&dis=<?php echo $_GET['dis'] ?>&sub=<?php echo $_GET['sub'] ?>&page_number=<?php echo $_GET['page_number'] ?>'"></i>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="ti-user mr-15"></i> <b>ฟอร์มแก้ไขผู้ใช้งาน</b>
                                            </h4>
    ...
    <script>
        ...
        async function getDataUserEdit() {
            let userId = '<?php echo $_GET['user_id'] ?>'
            $('#id').val(userId);
            $.ajax({
                type: "POST",
        ...
        function renderDataToForm(data) {
            ...
            if (!data.role_custom_id && data.role_id != 5) {
                if (data.role_id == 2) {
