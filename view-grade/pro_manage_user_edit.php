                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            <h4 class="box-title text-info col-md-10 text-left" style="margin: 0;">
                                                <?php $pageBack = 'pro_manage_user'; ?>
                                                <i class="ti-arrow-left" style="cursor: pointer;" onclick="window.location.href = '<?php echo $pageBack ?>?pro=<?php echo $_GET['pro'] ?>&dis=<?php echo $_GET['dis'] ?>&page_number=<?php echo $_GET['page_number'] ?>'"></i>
            ...
            $.ajax({
                ...
                success: async function(json) {
                    if (json.status) {
                        ...
                        window.location.href = 'pro_manage_user?pro=<?php echo $_GET['pro'] ?>&dis=<?php echo $_GET['dis'] ?>&page_number=<?php echo $_GET['page_number'] ?>'
                    } else {
                        alert(json.msg);
                        if (json.reload) {
