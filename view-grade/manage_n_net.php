...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                                ...
                                <div class="box-body no-padding">
                                    <div id="toolbar" class="row">
                                        <div class="col-12 row align-items-center">
                                            <h4 class="col-md-5">ตารางคะแนน N-NET</h4>
                                            <div class="col-md-4">
                                            ...
                                            <?php if ($_SESSION['user_data']->role_id == 3) { ?>
                                                <a class="waves-effect waves-light btn btn-success btn-flat ml-2" id="btn_add" onclick="goToAdd()"><i class="ti-pencil-alt"></i>&nbsp;คะแนน N-NET</a>
                                            <?php } ?>
                                        </div>
                                        <div class="col-12 row align-items-center">
                                            <?php
                                    ...
                                    <table id="table" data-icons="icons" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-minimum-count-columns="2" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-side-pagination="server" data-url="controllers/n_net_controller?getDataN_Net=true">
                                    </table>
                                </div>
                                <!-- /.box-body -->
                            </div>
    ...
    <script src="js/init-table/manage_n_net.js?v=<?php echo $version ?>"></script>

    <script>
        function goToAdd() {
            let term_id = $('#term_name').val();
            let term = $('#term_name option:selected').text();
            location.href = "manage_n_net_add?term_id=" + term_id + "&term=" + term
        }
