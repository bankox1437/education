        ...
        <div class="content-wrapper" style="margin: 0;">
            <div class="container-full">
                ...
                if (isset($_GET['sub_id'])) {
                    $sqlSubject = "SELECT ss.*,  CONCAT(t.term, '/' , t.year) term_name FROM vg_sum_kpc ss
                    INNER JOIN vg_terms t ON ss.term = t.term_id
                    WHERE ss.sub_id = :sub_id AND ss.user_create = :user_create AND ss.std_class = :std_class";
                ...
                if (count($dataSubject) > 0) {
                    ...
                    $term_name = $dataSubject[0]->term_name;
                }
                            ...
                            <div class="box">
                                ...
                                <div class="box-body no-padding">
                                    <!-- <div class="text-center">
                                        <h5 style="color: #000000;font-weight: bold;">ข้อมูลชั่วโมง กพช.</h5>
                                    </div> -->
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" style="font-size: 12px;">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            <th colspan="<?php echo count($dataColumn) + 1; ?>" class="text-center" id="work_head" style="width: 500px;">ข้อมูลชั่วโมง กพช. ปีการศึกษา <?php echo $term_name ?></th>
