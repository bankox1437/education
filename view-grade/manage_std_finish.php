...
<head>
    ...
    <title>จัดการรายชื่อนักศึกษาที่จบการศึกษา</title>
    <style>
        #table td {
            padding: 10px;
        }
...
<body class="hold-transition light-skin sidebar-mini theme-primary">
                            ...
                            <div class="box">
                                <div class="box-body no-padding">
                                    <div id="toolbar" class="row">
                                        <div class="col-12 row align-itesm-center">
                                            <h4 class="col-md-5">ตารางนักศึกษาที่จบการศึกษา</h4>
                                            <div class="col-md-4">
                                            ...
                                            <?php if ($_SESSION['user_data']->role_id == 3) { ?>
                                                <a class="waves-effect waves-light btn btn-success btn-flat ml-2 mt-3" id="btn_add" onclick="goToAdd()"><i class="ti-pencil-alt"></i>&nbsp;รายชื่อนักศึกษาที่จบการศึกษา</a>
                                            <?php } ?>
                                        </div>
                                    ...
                                    <table id="table" data-icons="icons" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-pagination="true" data-id-field="id" data-page-list="[10, 25, 50, 100, all]" data-side-pagination="server" data-url="controllers/std_finish_controller?getDataStdFinish=true">
                                    </table>
                                </div>
                                <!-- /.box-body -->
                            </div>
    ...
    <script src="js/init-table/manage_std_finish.js?v=<?php echo $version ?>"></script>

    <script>
        function goToAdd() {
            let term_id = $('#term_name').val();
            let term = $('#term_name option:selected').text();
            location.href = "manage_std_finish_add?term_id=" + term_id + "&term=" + term
        }
        ...
        // Call this function when either select element is changed
